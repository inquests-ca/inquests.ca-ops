...
CREATE TABLE IF NOT EXISTS `inquestsca`.`jurisdiction` (
  `jurisdictionId` CHAR(100) NOT NULL COMMENT 'Generally concatenation of federal code and division code (e.g., CAN_ON).',
  `federalJurisdictionId` CHAR(100) NULL,
  `name` VARCHAR(255) NOT NULL,
  `code` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`jurisdictionId`),
  UNIQUE INDEX `jurisdictionID_UNIQUE` (`jurisdictionId` ASC),
  INDEX `fk_jurisdictionId_jurisdiction1_idx` (`federalJurisdictionId` ASC),
  CONSTRAINT `fk_jurisdictionId_jurisdiction1`
    FOREIGN KEY (`federalJurisdictionId`)
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`authorityDocument` (
  ...
  CONSTRAINT `fk_authorityId_authorityDocument1`
    FOREIGN KEY (`authorityId`)
    REFERENCES `inquestsca`.`authority` (`authorityId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_sourceId_authorityDocument1`
    FOREIGN KEY (`sourceId`)
    REFERENCES `inquestsca`.`source` (`sourceId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_authorityDocumentTypeId_authorityDocument1`
...
-- -----------------------------------------------------
-- Table `inquestsca`.`deathCause`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inquestsca`.`deathCause` (
  `deathCauseId` CHAR(100) NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  `description` VARCHAR(1000) NULL,
  PRIMARY KEY (`deathCauseId`),
  UNIQUE INDEX `death_cause_id_UNIQUE` (`deathCauseId` ASC),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`deceased` (
  ...
  INDEX `fk_deathCauseId_deceased1_idx` (`deathCauseId` ASC),
  ...
  CONSTRAINT `fk_inquestTypeId_deceased1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_deathCauseId_deceased1`
    FOREIGN KEY (`deathCauseId`)
    REFERENCES `inquestsca`.`deathCause` (`deathCauseId`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `inquestsca`.`authorityTags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inquestsca`.`authorityTags` (
  `authorityId` INT UNSIGNED NOT NULL,
  `tag` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`authorityId`, `tag`),
  CONSTRAINT `fk_authorityId_authorityTags1`
    FOREIGN KEY (`authorityId`)
    REFERENCES `inquestsca`.`authority` (`authorityId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `inquestsca`.`inquestTags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inquestsca`.`inquestTags` (
  `inquestId` INT UNSIGNED NOT NULL,
  `tag` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`inquestId`, `tag`),
  CONSTRAINT `fk_inquestId_inquestTags1`
    FOREIGN KEY (`inquestId`)
    REFERENCES `inquestsca`.`inquest` (`inquestId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `inquestsca`.`authorityKeywordSynonyms`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inquestsca`.`authorityKeywordSynonyms` (
  `authorityKeywordId` CHAR(100) NOT NULL,
  `synonym` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`authorityKeywordId`, `synonym`),
  CONSTRAINT `fk_authorityKeywordId_authorityKeywordSynonyms1`
    FOREIGN KEY (`authorityKeywordId`)
    REFERENCES `inquestsca`.`authorityKeyword` (`authorityKeywordId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `inquestsca`.`inquestKeywordSynonyms`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `inquestsca`.`inquestKeywordSynonyms` (
  `inquestKeywordId` CHAR(100) NOT NULL,
  `synonym` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`inquestKeywordId`, `synonym`),
  CONSTRAINT `fk_inquestKeywordId_inquestKeywordSynonyms1`
    FOREIGN KEY (`inquestKeywordId`)
    REFERENCES `inquestsca`.`inquestKeyword` (`inquestKeywordId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN', NULL, 'Canada', 'CAN');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_AB', 'CAN', 'Alberta', 'AB');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_BC', 'CAN', 'British Columbia', 'BC');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_MB', 'CAN', 'Manitoba', 'MB');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_NB', 'CAN', 'New Brunswick', 'NB');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_NL', 'CAN', 'Newfoundland & Labrador', 'NL');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_NS', 'CAN', 'Nova Scotia', 'NS');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_NT', 'CAN', 'Northwest Territories', 'NT');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_NU', 'CAN', 'Nunavut', 'NU');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_ON', 'CAN', 'Ontario', 'ON');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_PE', 'CAN', 'Prince Edward Island', 'PE');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_QC', 'CAN', 'Québec', 'QC');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_SK', 'CAN', 'Saskatchewan', 'SK');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('CAN_YT', 'CAN', 'Yukon', 'YT');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('UK', NULL, 'United Kingdom', 'UK');
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `federalJurisdictionId`, `name`, `code`) VALUES ('US', NULL, 'United States', 'US');

COMMIT;


-- -----------------------------------------------------
-- Data for table `inquestsca`.`inquestCategory`
-- -----------------------------------------------------
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`inquestCategory` (`inquestCategoryId`, `name`, `description`) VALUES ('FACTOR', 'Factors', NULL);
INSERT INTO `inquestsca`.`inquestCategory` (`inquestCategoryId`, `name`, `description`) VALUES ('INQUEST', 'Inquest', NULL);
...
-- -----------------------------------------------------
-- Data for table `inquestsca`.`authorityCategory`
-- -----------------------------------------------------
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`authorityCategory` (`authorityCategoryId`, `name`, `description`) VALUES ('EVIDENCE', 'Evidence', NULL);
INSERT INTO `inquestsca`.`authorityCategory` (`authorityCategoryId`, `name`, `description`) VALUES ('FACTOR', 'Factors', NULL);
INSERT INTO `inquestsca`.`authorityCategory` (`authorityCategoryId`, `name`, `description`) VALUES ('INQUEST', 'Inquest', NULL);
