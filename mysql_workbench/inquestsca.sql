...
CREATE TABLE IF NOT EXISTS `inquestsca`.`documentSource` (
  ...
  `name` VARCHAR(255) NOT NULL,
  `isFree` TINYINT UNSIGNED NOT NULL DEFAULT 0,
...
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD', 'CAD', 'Canada', 1);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_AB', 'CAD', 'Alberta', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_BC', 'CAD', 'British Columbia', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_MB', 'CAD', 'Manitoba', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_NB', 'CAD', 'New Brunswick', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_NL', 'CAD', 'Newfoundland & Labrador', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_NS', 'CAD', 'Nova Scotia', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_NT', 'CAD', 'Northwest Territories', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_NU', 'CAD', 'Nunavut', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_ON', 'CAD', 'Ontario', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_PE', 'CAD', 'Prince Edward Island', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_QC', 'CAD', 'Québec', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_SK', 'CAD', 'Saskatchewan', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('CAD_YK', 'CAD', 'Yukon', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('UK', 'UK', 'United Kingdom', 1);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `isFederal`) VALUES ('US', 'US', 'United States', 1);
