...
CREATE TABLE IF NOT EXISTS `inquestsca`.`jurisdiction` (
  ...
  `name` VARCHAR(255) NULL COMMENT 'Generally a province, territory, or state. \nNULL implies this jurisdiction is federal.',
  `federal` TINYINT UNSIGNED NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`inquest` (
  ...
  `primary` TINYINT UNSIGNED NULL DEFAULT 0,
  `name` VARCHAR(255) NOT NULL,
  `overview` VARCHAR(255) NULL,
  `synopsis` VARCHAR(10000) NULL,
  `notes` VARCHAR(1000) NULL,
  `presidingOfficer` VARCHAR(255) NULL,
  `start` DATE NULL,
  `end` DATE NULL,
  `sittingDays` INT NULL,
  `exhibits` INT NULL,
  PRIMARY KEY (`inquestId`),
  UNIQUE INDEX `inquest_id_UNIQUE` (`inquestId` ASC),
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`documentSource` (
  ...
  `name` VARCHAR(255) NOT NULL,
  `hasPaywall` TINYINT UNSIGNED NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`inquestDocument` (
  ...
  CONSTRAINT `fk_inquestDocumentTypeId_inquestDocuments1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_documentSourceId_inquestDocuments1`
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`authorityKeyword` (
  ...
  `authorityCategoryId` CHAR(100) NULL,
  `name` VARCHAR(255) NOT NULL,
  `description` VARCHAR(255) NULL,
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`inquestType` (
  ...
  `name` VARCHAR(255) NULL,
  `mandatory` TINYINT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `inquestsca`.`deceased` (
  ...
  `inquestId` INT UNSIGNED NULL,
  `inquestTypeId` CHAR(100) NULL,
  `deathMannerId` CHAR(100) NULL,
  `deathCause` VARCHAR(255) NULL,
  `deathDate` DATE NULL,
...
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD', 'CAD', 'Canada', 1);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_AB', 'CAD', 'Alberta', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_BC', 'CAD', 'British Columbia', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_MB', 'CAD', 'Manitoba', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_NB', 'CAD', 'New Brunswick', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_NL', 'CAD', 'Newfoundland & Labrador', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_NS', 'CAD', 'Nova Scotia', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_NT', 'CAD', 'Northwest Territories', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_NU', 'CAD', 'Nunavut', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_ON', 'CAD', 'Ontario', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_PE', 'CAD', 'Prince Edward Island', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_QC', 'CAD', 'Québec', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_SK', 'CAD', 'Saskatchewan', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('CAD_YK', 'CAD', 'Yukon', 0);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('UK', 'UK', 'United Kingdom', 1);
INSERT INTO `inquestsca`.`jurisdiction` (`jurisdictionId`, `jurisdictionCategoryId`, `name`, `federal`) VALUES ('US', 'US', 'United States', 1);
...
START TRANSACTION;
USE `inquestsca`;
INSERT INTO `inquestsca`.`inquestType` (`inquestTypeId`, `name`, `mandatory`) VALUES ('CONSTRUCTION', 'Construction', 1);
INSERT INTO `inquestsca`.`inquestType` (`inquestTypeId`, `name`, `mandatory`) VALUES ('CUSTODY_INMATE', 'Custody-Inmate', 1);
INSERT INTO `inquestsca`.`inquestType` (`inquestTypeId`, `name`, `mandatory`) VALUES ('CUSTODY_POLICE', 'Custody-Police', 1);
INSERT INTO `inquestsca`.`inquestType` (`inquestTypeId`, `name`, `mandatory`) VALUES ('DISCRETIONARY', 'Discretionary', 0);
INSERT INTO `inquestsca`.`inquestType` (`inquestTypeId`, `name`, `mandatory`) VALUES ('MINING', 'Mining', 1);
